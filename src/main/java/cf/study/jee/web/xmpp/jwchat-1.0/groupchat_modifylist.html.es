...
onkeydown = keyPressed;
  ...
  <body style="margin:8px;">
		...
		<tr><td align="right">
		<button id="add_button" onClick="return addItem();">Añadir</button>&nbsp;<button id="delete_button" onClick="return deleteItem();">Borrar</button>&nbsp;<button type="submit" id="save_button" onClick="return doSub();">Guardar</button>
		</td>
		</tr>
		</table>
  </body>
