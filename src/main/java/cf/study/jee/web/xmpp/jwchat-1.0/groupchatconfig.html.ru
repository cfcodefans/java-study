...
<html>
  <head>
    <title>JWChat - Настройка канала для</title>
   ...
   function destroy() {
     reason = prompt("Действительно удалить эту комнату?\n\nПричина:","");
     if (!reason)
       return false;
  ...
  <body style="margin:8px;">
    <form name="sub" onsubmit="return doSub();">
      ...
      <div align="right" id="buttonbox">
        <button onClick="return destroy();">Удалить</button>&nbsp;<button onClick="window.close();">Отменить</button>&nbsp;<button type="submit">ОК</button>
      </div>
    </form>
  </body>
</html>
