...
function init() {
  ...
  document.title = "Чат с "+user.name;
...
onunload = cleanUp;
  ...
  <table width="100%" height="100%">
		...
		<tr>
		<td width="100%" valign=top><img src="images/unavailable.gif" name="statusLed" width=16 height=16 border=0 align=left><span id="user_name" class="link" onClick="return openUserInfo();" style="padding:2px;" title="Показать визитную карточку пользователя"></span><br clear=all>
		<span id="awaymsg" class="statusMsg"></span></td>
		<td align=right valign=top><button id='hist_button' onClick="return openUserHistory();">История</button></td></table>
		</td></tr>
    ...
    <tr id="submitbutton" style="display:none;"><td colspan=2 align=right><button onClick="submitClicked(); return false;">Отправить</button></td></tr>
	  </form>
  </table>
  </body>
</html>
