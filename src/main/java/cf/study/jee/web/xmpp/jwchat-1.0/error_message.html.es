...
onload = init;
  ...
  <body style="margin:8px;">
    ...
    <table width="100%" height="100%">
        ...
        <tr><td><hr noshade size="1"></td></tr>
        <tr><td align="right"><button onClick="return prev();" id="prevButton">anterior</button>&nbsp;<button onClick="return next();" id="nextButton">siguiente</button>&nbsp;<button onClick="window.close();">Cerrar</button></td></tr>
    </table>
    </form>
  </body>
</html>
