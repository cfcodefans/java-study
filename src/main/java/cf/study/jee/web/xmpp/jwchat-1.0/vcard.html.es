...
<form>
    <fieldset>
      ...
      <table>
          <tr><th nowrap>Nombre completo:</th><td width="100%"><input type=text id="FN" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Apellidos:</th><td width="100%"><input type=text id="N.FAMILY" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Nombre:</th><td width="100%"><input type=text id="N.GIVEN" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Apodo:</th><td width="100%"><input type=text id="NICKNAME" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table>
          <tr><th nowrap>Correo-e:</th><td width="100%"><input type=text id="EMAIL" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Página web:</th><td width="100%"><input type=text id="URL" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table>
          <tr><th nowrap>Direcci&oacute;n:</th><td width="100%"><input type=text id="ADR.STREET" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Direcci&oacute;n 2:</th><td width="100%"><input type=text id="ADR.EXTADD" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Ciudad:</th><td width="100%"><input type=text id="ADR.LOCALITY" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Estado:</th><td width="100%"><input type=text id="ADR.REGION" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>C&oacute;digo Postal:</th><td width="100%"><input type=text id="ADR.PCODE" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Pa&iacute;s:</th><td width="100%"><input type=text id="ADR.CTRY" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table>
          <tr><th nowrap>Nombre:</th><td width="100%"><input type=text id="ORG.ORGNAME" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Unidad:</th><td width="100%"><input type=text id="ORG.ORGUNIT" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>T&iacute;tulo:</th><td width="100%"><input type=text id="TITLE" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Rol:</th><td width="100%"><input type=text id="ROLE" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table width="100%">
          <tr><th>Cumplea&ntilde;os:</th><td width="100%"><input type=text id="BDAY" class="vcardBoxEditable"></td></tr>
		<tr><td colspan=2>&nbsp;</td></tr>
          <tr><th>Descripción:</th><td width="100%">&nbsp;</td></tr>
    ...
    <div id="savebox">
		...
		<div align="right">
			<button onClick="window.close();">Cancelar</button>&nbsp;<button onClick="return sendSub();">Guardar</button>
		</div>
      </div>
    </form>
	</body>
