...
function init() {
  ...
  if (user.messages.length > 0) {
    // show messages
    document.title = "Bericht van "+user.name; // set title
    getNextMSG();
    showMSG();
  }
}
...
onload = init;
  ...
  <body style="margin:8px;">
    ...
    <table width="100%" height="100%" border=0 cellpadding=0 cellspacing=0>
        <tr><td><b>Onderwerp:</b> <span id="subject"></span></td></tr>
        <tr><td><b>Datum:</b> <span id="date"></span></td></tr>
        ...
        <tr id="reply_buttons"><td align="right"><button onClick="return reply(true);">Citeren</button>&nbsp;<button onClick="return reply();">Beantwoorden</button>&nbsp;<button onClick="return openChat();">Chat</button></td></tr>

        <tr><td align="right" style="padding-top: 4px;"><button onClick="return prev();" id="prevButton">vorige</button>&nbsp;<button onClick="return next();" id="nextButton">volgende</button>&nbsp;<button onClick="window.close();">Sluiten</button></td></tr>
