...
<html>
  <head>
    <title>JWChat - Gebruikersinstellingen</title>
...
function init() {
  ...
  getArgs();
  jid = passedArgs['jid'];
  document.title = "Instellingen bewerken voor "+jid;
  ...
  for (var i=0; i<srcW.roster.groups.length; i++) {
    if (srcW.roster.groups[i].name != "Leeg") {
...
onload = init;
  ...
  <body style="margin: 8px;">
    <form name="userprops">
      <fieldset>
        <legend>Bijnaam van <span id="nickjid"></span></legend>
        <table border=0 cellspacing=0 cellpadding=0 width="100%">
            <tr>
              <td nowrap>Bijnaam:&nbsp;</td><td width="100%"><input type="text" name="nickname" style="width:100%"></td></tr>
        </table>
      </fieldset>
      <br>
      <fieldset>
        <legend>Groepen van <span id="groupjid"></span> </legend>
        <table>
            <tr>
              <td>
                <fieldset>
                  <legend>Beschikbare groepen</legend>
                  <table border=0 cellspacing=0 cellpadding=0 width="100%">
                      <tr>
                        <tr><td>Groep:&nbsp;</td><td width="100%"><input type="text" name="newgrp"></td></tr>
      ...
      <div align="right" id="buttonbox">
        <button onClick="window.close();">Annuleren</button>&nbsp;<button onClick="return submitClicked();">Ok</button>
      </div>
    </form>
  </body>
</html>
