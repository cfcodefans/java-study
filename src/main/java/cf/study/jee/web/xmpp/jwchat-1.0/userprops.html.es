...
onload = init;
  ...
  <body style="margin: 8px;">
    <form name="userprops">
      <fieldset>
        <legend>Editar apodo para <span id="nickjid"></span></legend>
        <table border=0 cellspacing=0 cellpadding=0 width="100%">
            <tr>
              <td nowrap>Apodo:&nbsp;</td><td width="100%"><input type="text" name="nickname" style="width:100%"></td></tr>
        </table>
      </fieldset>
      <br>
      <fieldset>
        <legend>Editar grupos para <span id="groupjid"></span></legend>
        <table>
            <tr>
              <td>
                <fieldset>
                  ...
                  <table border=0 cellspacing=0 cellpadding=0 width="100%">
                      <tr>
                        <tr><td>Nuevo:&nbsp;</td><td width="100%"><input type="text" name="newgrp"></td></tr>
      ...
      <div align="right" id="buttonbox">
        <button onClick="window.close();">Cancelar</button>&nbsp;<button onClick="return submitClicked();">Aceptar</button>
      </div>
    </form>
  </body>
</html>
