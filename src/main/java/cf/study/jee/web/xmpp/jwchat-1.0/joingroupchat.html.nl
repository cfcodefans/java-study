...
<html>
  <head>
    <title>JWChat - Chatruimte betreden</title>
  ...
  <body style="margin:8px;">
    <form name="sub" onsubmit="return doSub();">
      <table border="0" width="100%">
          <tr><td colspan="2">Chatruimtes zoeken <button onClick="return openSearchRooms();">Zoekvenster openen</button></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
          <tr><td>Bladwijzer</td><td><select id="bookmark_selector" onChange="return bookmark_selected(this);"><option value=""> - Bladwijzer kiezen - </option></select> <button onClick="return srcW.openEditBookmarks();">Bewerken</button></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
      ...
      <div align="right" id="buttonbox">
        <button type="button" onClick="window.close();">Annuleren</button>&nbsp;<button type="submit">Betreden</button>
      </div>
    </form>
  </body>
</html>
