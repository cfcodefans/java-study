...
<html>
  <head>
    <title>JWChat - Aanwezigheid veranderen</title>
    ...
    <form name="statF">
      <table width="100%" height="100%" border=0 cellpadding=0 cellspacing=0 style="margin-bottom: 8px;">
          <tr>
            ...
            <td><input type=radio name="status" value="xa" id="xa"><label for="xa"><img src="images/xa.gif"> langdurig afwezig</label></td>
          </tr>
          <tr>
            <td><input type=radio name="status" value="chat" id="chaty"><label for="chaty"><img src="images/chat.gif"> chat</label></td>
            <td><input type=radio name="status" value="dnd" id="dnd"><label for="dnd"><img src="images/dnd.gif"> niet storen</label></td>
          </tr>
          <tr>
            <td><input type=radio name="status" value="away" id="away"><label for="away"><img src="images/away.gif"> afwezig</label></td>
            <td><input type=radio name="status" value="unavailable" id="unavailable"><label for="unavailable"><img src="images/invisible.gif"> Onzichtbaar</label></td>
          </tr>
          <tr id="offline">
          ...
          <tr><td colspan=2><b>Aanwezigheidsbericht:</b></td></tr>
          ...
          <tr><td colspan=2 align="right" id="buttonbox"><button onClick="window.close();">Annuleren</button>&nbsp;<button onClick="return doSubmit();">Instellen</button></td></tr>
      </table>
    </form>
  </body>
</html>
