...
function loginCheck(form) { 
  ...
  if (document.getElementById('tr_server').style.display != 'none') {
    ...
    if (val == '') {
      alert("U moet een Jabber-server opgeven");
      return false;
    }
...
function init() {
  var welcome = "Welkom bij JWChat op "+SITENAME;
  ...
  if (typeof(BACKENDS) == 'undefined' || BACKENDS.length == 0) {
    ...
    label.appendChild(document.createTextNode("Verbindingsmethode kiezen"));
  ...
  <body>
        ...
        <tr>
          <td align=center id='td_top'>
            <table>
                <tr>
                  <td>
                    <h1 id="welcomeh1">Welkom bij JWChat</h1>
                    <h2>Een webgebaseerde Jabber<sup><small>&reg;</small></sup>-client</h2>
                  </td>
                </tr>
            </table>
          </td>
      ...
      <tr>
        <td height="100%" align=center valign=top id='td_form'>
          <table border=0 cellspacing=0 cellpadding=2 id="lTable" align=center width=380>
              <tr>
                <td colspan=2><h3>Aanmelden<img src="images/available.gif" width=16 height=16></h3></td>
              </tr>
              <tr id="tr_server" style="display:none;">
                <th title="Selecteer een Jabber-server waarmee verbonden moet worden"><label for='server'>Server</label></th>
                <td></td>
              </tr>
              <tr>
                <th class='form_spacer'><label for='jid'>Gebruikersnaam</label></th>
                <td class='form_spacer' width="100%"><input type="text" id='jid' name="jid" tabindex=3 class='input_text'></td>
              </tr>
              <tr><td>&nbsp;</td><td nowrap class="desc">Volgende tekens mogen niet voorkomen in uw gebruikersnaam:: <span id='chars_prohibited'></span></td></tr>
              <tr>
                <th><label for='pass'>Wachtwoord</label></th>
                <td><input type="password" id='pass' name="pass" tabindex=4 class='input_text'></td>
              </tr>
              <tr><td>&nbsp;</td><td><input type=checkbox name=register id=register> <label for="register">Nieuwe account registreren</label></td></tr>
              <tr id="showMoreOpts" class="toggleOpts">
                <td>&nbsp;</td>
                <td onClick="return toggleMoreOpts(1);"><img src="images/group_close.gif" title="Meer opties"> Meer opties</td>
              </tr>
              <tr id="showLessOpts" class="toggleOpts" style="display:none;">
                <td>&nbsp;</td>
                <td onClick="return toggleMoreOpts(0);"><img src="images/group_open.gif" title="Minder opties"> Minder opties</td>
              </tr>
              <tr class="moreOpts" style="display:none;">
                <th><label for='res'>Bron</label></th>
                <td><input type="text" id="res" name="res" class="input_text"></td>
					</tr>
              <tr class="moreOpts" style="display:none;">
                <th><label for='prio'>Prioriteit</label></th>
                <td>
                  <select type="text" id="prio"  name="prio" class="input_text" size="1">
                    <option value="0">laag</option>
                    <option value="10" selected>gemiddeld</option>
                    <option value="100">hoog</option>
                  </select>
                </td>
              </tr>
              <tr class="moreOpts" style="display: none;">
		<th class="form_spacer"><label for="connect_port">Poort</label></th>
                <td class="form_spacer"><input type="text" name="connect_port" id="connect_port" class="input_text" disabled></td>
              </tr>
              <tr class="moreOpts" style="display: none;">
	        <th><label for="connect_host">Computer verbinden</label></th>
                <td><input type="text" name="connect_host" id="connect_host" class="input_text" disabled></td>
              </tr>
              <tr class="moreOpts" style="display: none;">
                <td>&nbsp;</td>
		<td><input type="checkbox" name="connect_secure" id="connect_secure" class="input_text" disabled> <label for="connect_secure" title="Connectiebeheer adviseren om te verbinden via SSL" disabled>Allow secure conncetions only</label></td>
              </tr>
              
              <tr><td>&nbsp;</td><td><button type="submit" id='login_button' tabindex=5 disabled>Aanmelden</button></td></tr>
          </table>
    </form>	
  </td>
  </tr>
    <tr>
      <td id='td_bottom'>
        ...
        Bezoek <a href="http://jwchat.sourceforge.net">JWChat's webstek</a> voor meer informatie.
        <br>
