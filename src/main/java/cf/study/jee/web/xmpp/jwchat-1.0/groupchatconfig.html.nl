...
<html>
  <head>
    <title>JWChat - Chatruimte-instellingen voor</title>
   ...
   function destroy() {
     reason = prompt("Wilt u werkelijk deze chatruimte vernietigen?\n\nReden:","");
     if (!reason)
       return false;
  ...
  <body style="margin:8px;">
    <form name="sub" onsubmit="return doSub();">
      ...
      <div align="right" id="buttonbox">
        <button onClick="return destroy();">Vernietigen</button>&nbsp;<button onClick="window.close();">Annuleren</button>&nbsp;<button type="submit">Ok</button>
      </div>
    </form>
  </body>
</html>
