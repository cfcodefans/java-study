  ...
  <body style="margin:8px">
    <form name="statF">
      <table width="100%" height="100%" border=0 cellpadding=0 cellspacing=0 style="margin-bottom: 8px;">
          ...
          <tr>
            <td><input type=radio name="status" value="chat" id="chaty"><label for="chaty"><img src="images/chat.gif"> свободен для чата</label></td>
          ...
          <tr><td colspan=2 align="right" id="buttonbox"><button onClick="window.close();">Отменить</button>&nbsp;<button onClick="return doSubmit();">Установить</button></td></tr>
      </table>
    </form>
  </body>
</html>
