  ...
  <body style="margin: 8px;">
		<table width="100%" height="100%">
			<form name="invite_form">
				<tr>
					<td valign=top nowrap>Seleccionar Usuario(s):</td><td align=left width="100%"><select name="users_selector" id="users_selector" size=3 multiple style="width:100%;"></select></td>
				</tr>
				<tr><td colspan=2>Razón:</td></tr>
				<tr><td width="100%" height="100%" colspan=2><textarea name="reason" style="width:100%;height:100%"></textarea></td></tr>
				<tr><td colspan=2><hr noshade size=1></td></tr>
				<tr>
					<td align=right colspan=2>
						<button type=submit onClick="return doSub();">Invitar</button>
					</td>
				</tr>
			</form>
		</table>
