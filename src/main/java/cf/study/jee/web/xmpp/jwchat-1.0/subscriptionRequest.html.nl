...
<html>
  <head>
    <title>JWChat - Aanvraag voor inschrijving op aanwezigheid</title>
...
function init() {
  ...
  document.title = "Inschrijvingsaanvraag van "+jid;

  var from = "<b><span class=\"link\" onClick=\"return srcW.openUserInfo('"+jid+"');\" title=\""+"gebruikersinformatie van "+jid+" laten zien"+"\">"+jid.substring(0,jid.indexOf('@'))+"</a></b> ";
...
onload = init;
  ...
  <body style="margin:8px;">
    <table  width="100%" height="100%" border=0 cellpadding=0 cellspacing=0 style="margin-bottom: 8px;">
      <tr><td>
        <span id="requestingUser"></span> wilt u toevoegen aan zijn of haar roster:
      </td></tr>
      ...
      <tr><td align="right">
          <button onClick="return sendUnsub();">Ontzeggen</button>&nbsp;<button onClick="return sendSub();" tabindex=1>Toestaan</button>
        </td></tr>
      </form>
    </table>
  </body>
