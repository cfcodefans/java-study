  ...
  <body style="margin:8px;">
    <form name="sub" onsubmit="return doSub();">
      <table border="0" width="100%">
          <tr><td>Marcador</td><td><select id="bookmark_selector" onChange="return bookmark_selected(this);"><option value=''> - Elegir Marcador - </option></select></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
          <tr><td>Nombre</td><td><input type="text" name="save_bookmark_as" size="32" style="width: 100%;"></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
          ...
          <tr><td nowrap>Auto unirse</td><td><input type="checkbox" name="autojoin"></td></tr>
      </table>
      ...
      <div align="right" id="buttonbox">
        <button type="button" onClick="window.close();">Cancelar</button>&nbsp;<button type="submit">Guardar</button>
      </div>
    </form>
  </body>
</html>
