...
<html>
  <head>
    <title>JWChat - Bladwijzers bewerken</title>
...
function saveBookmark() {
  ...
  if (document.forms[0].save_bookmark_as.value == '') {
    alert("Voer een naam voor deze bladwijzer in!");
    return false;
  }
  ...
  if (document.forms[0].group.value == '') {
    alert("Voer de naam in van de chatruimte die u wenst te betreden");
    return false;
  }

  if (document.forms[0].server.value == '') {
    alert("Voer de naam in van een server");
    return false;
  }
  ...
  <body style="margin:8px;">
    <form name="sub" onsubmit="return doSub();">
      <table border="0" width="100%">
          <tr><td>Bladwijzer</td><td><select id="bookmark_selector" onChange="return bookmark_selected(this);"><option value=''> - Bladwijzer kiezen - </option></select></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
          <tr><td>Naam</td><td><input type="text" name="save_bookmark_as" size="32" style="width: 100%;"></td></tr>
          <tr><td colspan="2"><hr noshade size="1"></td></tr>
          <tr><td nowrap>Bijnaam</td><td width="100%"><input type="text" name="nick" size="32" style="width:100%;"></td></tr>
          <tr><td nowrap>Chatruimte</td><td width="100%"><input type="text" name="group" size="32" style="width:100%;"></td></tr>
          <tr><td nowrap>Server</td><td width="100%"><input type="text" name="server" size="32" style="width:100%;"></td></tr>
          <tr><td nowrap>Wachtwoord</td><td width="100%"><input type="text" name="pass" size="32" style="width:100%;"></td></tr>
          <tr><td nowrap>Automatisch betreden</td><td><input type="checkbox" name="autojoin"></td></tr>
      </table>
      ...
      <div align="right" id="buttonbox">
        <button type="button" onClick="window.close();">Annuleren</button>&nbsp;<button type="submit">Opslaan</button>
      </div>
    </form>
  </body>
</html>
