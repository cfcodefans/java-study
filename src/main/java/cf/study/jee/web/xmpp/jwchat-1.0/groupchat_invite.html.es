...
onload = init;
  ...
  <body style="margin:8px;">
		...
		<tr><td colspan=2><h2 id="title">Invitación a Sala de charla</h2></td></tr>
		<tr><td>Sala:</td><td id="to"></td></tr>
		<tr><td>De:</td><td id="from"></td></tr>
		<tr><td>Razón:</td><td id="reason"></td></tr>
		<tr><td colspan=2><hr noshade size=1></td></tr>
    <form name="sub" onsubmit="return doSub();">
		<tr><td colspan=2 width="100%" height="100%">
		<table width="100%" height="100%">
		<tr><td><input type=radio name="invite" value="join" id="join" checked></td><td><label for="join">Entrar</label></td></tr>
		<tr><td><input type=radio name="invite" value="decline" id="decline"></td><td><label for="decline">Declinar</label></td></tr>
		<tr><td>&nbsp;</td><td>Razón:</td></tr>
		<tr>
		<td>&nbsp;</td>
