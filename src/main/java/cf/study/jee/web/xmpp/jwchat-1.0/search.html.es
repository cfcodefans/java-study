...
onload = init;
  ...
  <body style="margin: 8px;">
		...
		Restringir b&uacute;squeda a <select name="service" onChange="return serviceSelected(this);"><option value=''>- Elige Directorio -</option></select>
		</form>
		...
		<tr><td id="results_header">Consultando ...</td></tr>
