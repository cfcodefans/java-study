...
onload = init;
  ...
  <body style="margin:8px;">
    ...
    <table width="100%" height="100%">
        <tr><td style="color: red;"><b>Fout <span id="error_code"></span>:</b> <span id="error_data"></span></td></tr>
        ...
        <tr><td><hr noshade size="1"></td></tr>
        <tr><td align="right"><button onClick="return prev();" id="prevButton">vorige</button>&nbsp;<button onClick="return next();" id="nextButton">volgende</button>&nbsp;<button onClick="window.close();">Sluiten</button></td></tr>
    </table>
    </form>
  </body>
</html>
