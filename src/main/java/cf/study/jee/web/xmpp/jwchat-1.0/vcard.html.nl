...
<form>
    <fieldset>
      <legend>Naam</legend>
      <table>
          <tr><th nowrap>Volledige naam:</th><td width="100%"><input type=text id="FN" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Familienaam:</th><td width="100%"><input type=text id="N.FAMILY" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Naam:</th><td width="100%"><input type=text id="N.GIVEN" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Bijnaam:</th><td width="100%"><input type=text id="NICKNAME" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table>
          ...
          <tr><th nowrap>Webstek:</th><td width="100%"><input type=text id="URL" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      <legend>Adres</legend>
      <table>
          <tr><th nowrap>Adres:</th><td width="100%"><input type=text id="ADR.STREET" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Adres2:</th><td width="100%"><input type=text id="ADR.EXTADD" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Stad:</th><td width="100%"><input type=text id="ADR.LOCALITY" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Provincie:</th><td width="100%"><input type=text id="ADR.REGION" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Postcode:</th><td width="100%"><input type=text id="ADR.PCODE" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Land:</th><td width="100%"><input type=text id="ADR.CTRY" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      ...
      <table>
          <tr><th nowrap>Naam:</th><td width="100%"><input type=text id="ORG.ORGNAME" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Afdeling:</th><td width="100%"><input type=text id="ORG.ORGUNIT" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Titel:</th><td width="100%"><input type=text id="TITLE" class="vcardBoxEditable"></td></tr>
          <tr><th nowrap>Functie:</th><td width="100%"><input type=text id="ROLE" class="vcardBoxEditable"></td></tr>
      </table>
    </fieldset>
    ...
    <fieldset>
      <legend>Over</legend>
      <table width="100%">
          <tr><th>Geboortedatum:</th><td width="100%"><input type=text id="BDAY" class="vcardBoxEditable"></td></tr>
		<tr><td colspan=2>&nbsp;</td></tr>
          <tr><th>Beschrijving:</th><td width="100%">&nbsp;</td></tr>
    ...
    <div id="savebox">
		...
		<div align="right">
			<button onClick="window.close();">Annuleren</button>&nbsp;<button onClick="return sendSub();">Opslaan</button>
		</div>
      </div>
    </form>
	</body>
