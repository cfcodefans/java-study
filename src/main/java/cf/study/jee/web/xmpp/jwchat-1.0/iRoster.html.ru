...
<html>
  ...
  <body class="roster">
    ...
    <nobr><div class="menuitems" func="roster.openChat">Начать чат</div></nobr>
		<nobr><div class="menuitems" func="roster.openMessage">Отправить сообщение</div></nobr>
    <nobr><div class="menuitems" func="openCustomPresence">Присутствие</div></nobr>
    <nobr><div class="menuitems" func="openUserProps">Редактировать пользователя</div></nobr>
    <nobr><div class="menuitems" func="openUserInfo">Показать информацию</div></nobr>
    <nobr><div class="menuitems" func="openUserHistory" id='hist_menuitem'>История</div></nobr>
    <nobr><div class="menuitems" func="openUserNote">Редактировать заметку</div></nobr>
    <div class="menuitems" func="openSubscription">Переавторизоваться</div>
    <div class="menuitems" func="removeUser">Удалить</div>
  </div>
    ...
    <nobr><div class="menuitems" func="openCustomPresence">Присутствие</div></nobr>
    <nobr><div class="menuitems" func="openUserProps">Редактировать</div></nobr>
    <nobr><div class="menuitems" func="openUserInfo">Показать информацию</div></nobr>
  </div>
    ...
    <nobr><div class="menuitems" func="openGroupchat">Показать</div></nobr>
    <nobr><div class="menuitems" func="openCustomPresence">Присутствие</div></nobr>
    <nobr><div class="menuitems" func="openUserInfo">Показать информацию</div></nobr>
  </div>
