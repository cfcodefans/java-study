...
<html>
  <head>
    <title>JWChat - Geschiedenis</title>
...
function deleteHistory() {
  if (!confirm("Wilt u werkelijk de geschiedenis van deze chatsessie volledig verwijderen?"))
	return;
...
function init() {
	...
	var dtitle = "Geschiedenis voor "+user.name;
...
onload = init;
  ...
  <body style="margin:8px;">
		<table width="100%" height="100%" border=0>
				<tr>
					<td><h2 id="title"></h2></td><td align="right"><button onClick="deleteHistory();">Verwijderen</button> <button onClick="reloadHistory();">Vernieuwen</td>
				</tr>
				<tr height="100%">
					<td>
