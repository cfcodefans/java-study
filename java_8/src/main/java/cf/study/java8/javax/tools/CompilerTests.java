...
public class CompilerTests {
	 ...
	 * 
	 * @param fileName	source filename to be used for error message etc.
	 * @param source	source java source as String
	 * @param err		error writer where diagnostic message are written
	 * @param srcPath	sourcePath locatoin of additional .java source files
	 * @param clsPath	classPath location of additinal .class files
	 * @return
	 * @throws Exception
	 */
