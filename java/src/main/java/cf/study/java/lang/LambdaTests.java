...
public class LambdaTests {
    ...
    public void recusive() {
        final Consumer<Spliterator<Integer>> c = (s) -> {
//            if (s.tryAdvance(System.out::println)) c.accept(s); //can't compile
        };
        c.accept(IntStream.range(0, 10).mapToObj(Integer::valueOf).spliterator());
    }
