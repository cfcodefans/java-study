package cf.study.java.lang.keywords;
...
//				continue _1; //continue can't be used outside of loop
		...
		System.out.println();
		{
			...
			case 5:
				...
				// break _1;
				// continue _1; continue can't be used outside of loop
				// for() {continue _1}; no statement between label and outer
				// loop
			case 6:
				System.out.println(6);
			case 7:
	...
	public void testSwitchWithNull() {
		...
		{
			final String _str = "i"; // constant literal
			final String _random = String.valueOf(System.currentTimeMillis()); // non
																				// constant
																				// expression
			String str = "d"; // null; //switch will throw NullPointerException
								// for null value
