...
import rocks.xmpp.core.session.XmppClient;import rocks.xmpp.core.stanza.model.Presence;
...
public class XmppClientTests {
	...
	public void testXmppClientConn() throws Exception {
		...
		TcpConnectionConfiguration tcpCfg = TcpConnectionConfiguration.builder()
				.hostname("atkins.thenetcircle.lab")
				.port(5222)
				.sslContext(sslCtx)
				.keepAliveInterval(5)
				.build();
